...
//
// NOTE: CKP/CMP waveforms and the 8 coil/injector firing animations are DERIVED in the
// browser from `rpm` (+ cm/cp), per the locked "fluidity = cadence + interpolation"
// decision — they are NOT streamed. When real per-channel coil/injector sensing is added,
// extend this contract with `cl`/`in` 8-bit masks and have the engine prefer them.
